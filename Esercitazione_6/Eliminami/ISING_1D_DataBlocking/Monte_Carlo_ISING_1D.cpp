...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    Ene.open("Risultati/output.ene.0",ios::app);
...
// INCLUDE YOUR CODE HERE
    ...
    Cap.open("Risultati/output.capacity.0",ios::app);
    ...
    Susc.open("Risultati/output.susceptibility.0",ios::app);
    ...
    Magn.open("Risultati/output.magnetization.0",ios::app);
